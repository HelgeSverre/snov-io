...
class EmailFinder extends BaseResource
{
     ...
     */
    public function emailCount(array $data): Response
    {
        return $this->connector->send(new EmailCountRequest(...$data));
    }
     ...
     */
    public function emailFinder(array $data): Response
    {
        return $this->connector->send(new EmailFinderRequest(...$data));
    }
     ...
     */
    public function addNamesToFindEmails(array $data): Response
    {
        return $this->connector->send(new AddNamesToFindEmailsRequest(...$data));
    }

    /**
     * Find prospects by social URL. To receive the results, use the Get prospect with URL method.
     */
    public function addURLToSearchForProspect(array $data): Response
    {
        return $this->connector->send(new AddURLToSearchForProspectRequest(...$data));
    }
     ...
     */
    public function getProspectWithURL(array $data): Response
    {
        return $this->connector->send(new GetProspectWithURLRequest(...$data));
    }

    /**
     * Provide an email address and Snov.io will return all the profile information connected to the provided email address owner from the database.If we find no information about the email owner in our database, you will not be charged for the request.
     */
    public function getProfileWithEmail(array $data): Response
    {
        return $this->connector->send(new GetProfileWithEmailRequest(...$data));
    }
}
